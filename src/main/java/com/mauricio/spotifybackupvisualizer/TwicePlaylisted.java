...
public class TwicePlaylisted {
    public static List<String> twicePlaylisted(String path) throws IOException {
        ...
        int cont = 0;
        List<String> duplicatedMusics = new ArrayList<>();
        ...
        for (Tracks tracks : yourLibrary.getTracks()) {
            ...
            if (cont > 1) {
                duplicatedMusics.add(tracks.getTrack());
            }
            cont = 0;
        }
        return duplicatedMusics;
    }
}
